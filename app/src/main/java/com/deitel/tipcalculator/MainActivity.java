...
public class MainActivity extends AppCompatActivity {
    ...
    private double peopleAmount = 0;    // zin
    private TextView peopleTextView;    // zin
    private TextView eachTextView;      //zin
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        peopleTextView = (TextView) findViewById(R.id.peopleTextView);  // zin
        eachTextView.setText(currencyFormat.format(0));                 // zin
        ...
        //set peopleEditText's TextWatcher// zin
    ...
    private void calculate() {
        ...
        double total_ppl = total / peopleAmount; //zin


        // display tip and total formatted as currency
        tipTextView.setText(currencyFormat.format(tip));
        totalTextView.setText(currencyFormat.format(total));
        eachTextView.setText(currencyFormat.format(total_ppl)); // zin
    ...
    // listener object for the EditText's text-changed events // zin

    private final TextWatcher peopleEditTextWatcher = new TextWatcher() {

        //called when the user change the amount of party
        @Override
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {

            try {
                billAmount = Double.parseDouble(s.toString());
                eachTextView.setText(currencyFormat.format(billAmount));

            } catch (NumberFormatException e) {
                eachTextView.setText("");
                peopleAmount = 0;
            }
